    ...
    <html lang="en" className={`${inter.variable} ${playfair.variable}`}>
      <head>
        <meta
          ...
          content="CA6P_Ot-bfagJ0OuImO_OnVuZ6JrQNZx3s6Lj51PSdQ"
        />
      </head>
      <body
        className="min-h-screen text-stone-700"
        style={{
          background: 'linear-gradient(135deg, #e0f2e9 0%, #fef9e6 100%)',
        }}
      >
        <Navigation />
        ...
        <footer className="border-t border-stone-200/60 bg-white/60 backdrop-blur-sm">
          ...
          <div className="max-w-6xl mx-auto px-4 py-6 text-sm text-stone-500">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 mb-4">
              ...
              <a
                href="https://aiagentsdirectory.com/agent/pause-app?utm_source=badge&utm_medium=referral&utm_campaign=free_listing&utm_content=pause-app"
                target="_blank"
                rel="noopener noreferrer"
              >
                <img
                  src="https://aiagentsdirectory.com/featured-badge.svg?v=2024"
                  alt="Pause App - Featured AI Agent on AI Agents Directory"
                  width="200"
                  height="50"
                />
              </a>
            ...
            <div className="flex flex-wrap justify-center gap-6">
              ...
              <Link href="/changelog" className="hover:text-stone-700">
                Changelog
              </Link>
              <Link href="/faq" className="hover:text-stone-700">
                FAQ
              </Link>
